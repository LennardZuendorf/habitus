...
function hideCookieBanner(){
    ...
    console.log(window.localStorage.getItem("ignitr_cookieCheck"))
}

/* Checks the localstorage and shows Cookie banner based on it. */
function initializeCookieBanner(){

    let isCookieAccepted = window.localStorage.getItem("ignitr_cookieCheck");
    ...
    if(isCookieAccepted === "no"){
        ...
        window.localStorage.setItem("ignitr_cookieCheck", "no");
        console.log("cookie banner not accepted - showing banner")
        showCookieBanner();
